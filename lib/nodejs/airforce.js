...
{
    'JT': 'https://atc.airforce.mil.kr:444/user/indexSub.action?codyMenuSeq=156894686&siteId=tong-new&menuUIType=sub',
    'K1': 'https://atc.airforce.mil.kr:444/user/indexSub.action?codyMenuSeq=157620025&siteId=gisool2&menuUIType=sub',
    'K2': 'https://atc.airforce.mil.kr:444/user/indexSub.action?codyMenuSeq=157615558&siteId=gunsu&menuUIType=sub',
    'HJ': 'https://atc.airforce.mil.kr:444/user/indexSub.action?codyMenuSeq=159014200&siteId=haengjeong&menuUIType=sub',
    'BP': 'https://atc.airforce.mil.kr:444/user/indexSub.action?codyMenuSeq=158327574&siteId=bangpogyo&menuUIType=sub',
    'HR': 'https://atc.airforce.mil.kr:444/user/indexSub.action?codyMenuSeq=156893223&siteId=last2&menuUIType=sub'
};
...
module.exports = {
    mailWrite: async function (soldierName, soldierInfo, articles, schoolID, writeablePeriodMax) {
        ...
        for (i = 0; i < Object.keys(articles).length; i++) {
            ...
            $('#senderAddr2').attr('value','111동 111호');
